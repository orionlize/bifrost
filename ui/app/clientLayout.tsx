...
function AppContent({ children }: { children: React.ReactNode }) {
	...
	const { data: authState, isLoading: authLoading, isFetching: authFetching } = useIsAuthEnabledQuery(undefined, { skip: publicShell });
	...
	const authSessionReady = authState?.is_auth_enabled !== true || authState.has_valid_token === true;
