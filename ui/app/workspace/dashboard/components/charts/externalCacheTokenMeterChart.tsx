					...
					<div>
						<div className="flex shrink-0 flex-col items-center pt-1 leading-none">
							...
							<div className="mt-1 flex items-center gap-1 text-[11px] text-zinc-400">
								<span>{t("dashboardCharts.cache.externalOfInput")}</span>
								<Tooltip>
									<TooltipTrigger asChild>
										<button
											...
											aria-label={t("dashboardCharts.cache.externalInfoAria")}
										>
											<Info className="h-3 w-3" />
										</button>
									</TooltipTrigger>
									<TooltipContent side="top">{t("dashboardCharts.cache.externalTooltip")}</TooltipContent>
								</Tooltip>
							</div>
						</div>
