...
type LogStore interface {
	...
	// GetVirtualKeyUsageRankings aggregates usage for the given virtual keys in the
	// current filter window and the previous period of equal duration.
	GetVirtualKeyUsageRankings(ctx context.Context, filters SearchFilters, virtualKeyIDs []string) (map[string]VirtualKeyUsageAggregate, map[string]VirtualKeyUsageAggregate, error)
